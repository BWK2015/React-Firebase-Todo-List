...
var Header = React.createClass({
    ...
    render: function () {
        return React.createElement(
            ...
            React.createElement("input", { value: this.state.text, onChange: this.handleInputValue, type: "text", className: "form-control" }),
            React.createElement(
                "span",
...
var ListItem = React.createClass({
    ...
    handleButtonChange: function () {
        if (this.state.textChanged) {
            return [React.createElement(
                'button',
                { className: 'btn btn-default', onClick: this.handleSave, key: 1 },
                'Save'
            ), React.createElement(
                'button',
                { className: 'btn btn-default', onClick: this.handleUndo, key: 2 },
                'Undo'
            )];
        } else {
            return null;
    ...
    render: function () {
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement('input', { type: 'checkbox', checked: this.state.done, onChange: this.handleDoneChange })
            ),
            React.createElement('input', { type: 'text', className: 'form-control', disabled: this.state.done, value: this.state.text, onChange: this.handleTextChange }),
            React.createElement(
                'span',
                { className: 'input-group-btn' },
                ...
                React.createElement(
                    'button',
                    { className: 'btn btn-default', onClick: this.handleDelete },
                    'Delete'
                )
            )
        );
...
},{"firebase":2,"react":159}],163:[function(require,module,exports){
var React = require('react');
...
var List = React.createClass({
    ...
    renderList: function () {
        if (this.props.items['.value'] === null) {
            ...
            for (var key in this.props.items) {
                ...
                item.id = key;
                children.push(React.createElement(ListItem, { key: key, todo: item }));
            };
    ...
    render: function () {
        return React.createElement(
            'div',
            { className: this.props.class ? 'content loaded' : 'content' },
            this.renderList()
        );
    }
});
...
},{"./list-item":162,"react":159}],164:[function(require,module,exports){
var rootUrl = 'https://todosreactproject.firebaseio.com/';
    ...
    deleteButton: function () {
        if (this.state.loaded) {
            return React.createElement(
                ...
                React.createElement(
                    'button',
                    { onClick: this.onDeleteClick, type: 'button', className: 'btn btn-default' },
                    'Clear Complete'
                )
            );
        } else {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement('hr', null),
                    React.createElement(List, { items: this.state.items, 'class': this.state.loaded }),
                    this.deleteButton()
                )
            )
        );
...
},{"./header":161,"./list":163,"./root":164,"firebase":2,"react":159,"react-dom":3,"reactfire":160}]},{},[165]);
